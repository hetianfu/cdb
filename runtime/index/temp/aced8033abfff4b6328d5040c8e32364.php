<?php /*a:2:{s:57:"/opt/homebrew/var/www/cdb/app/index/view/sem/regsems.html";i:1645409812;s:59:"/opt/homebrew/var/www/cdb/app/index/view/public/header.html";i:1632829660;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title></title>
...
<div class="layui-container">
    ...
    <div class="login_form">
        ...
        <div>
            ...
            <div class="layui-form-item">
                <input type="text" class="layui-input" id="parent_code" value="<?php echo htmlentities($parent_code); ?>" name="parent_code" placeholder="<?php echo htmlentities(lang('fx_invite_code')); ?>">
            </div>
        </div>
