<?php /*a:4:{s:63:"/www/wwwroot/hgcdb.test138.com/app/index/view/index/zhitui.html";i:1615959550;s:64:"/www/wwwroot/hgcdb.test138.com/app/index/view/public/header.html";i:1632829661;s:62:"/www/wwwroot/hgcdb.test138.com/app/index/view/public/kefu.html";i:1616171411;s:62:"/www/wwwroot/hgcdb.test138.com/app/index/view/public/foot.html";i:1631773953;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title><?php echo htmlentities(lang('te_team')); ?></title>
...
<body>
	<div class="header">
		<span><?php echo htmlentities(lang('te_team')); ?></span>
	</div>
	<div class="back">
	...
	<div class="team">
		<p>
			<a href="<?php echo url('index/Index/zhitui'); ?>"><?php echo htmlentities(lang('te_direct_push')); ?></a>
		</p>
		<a href="<?php echo url('index/Index/feizhitui'); ?>" ><?php echo htmlentities(lang('te_no_direct_push')); ?></a>
	</div>
	...
	<div class="teambox">
		...
		<div class="libox">
			<div class="lf">
				<p><?php echo htmlentities($v['username']); ?></p>
				<a href=""><?php echo htmlentities(lang('te_congratulations')); ?></a>
			</div>
			<div class="lr">
				<p class="p1"><?php echo htmlentities(lang('te_his_earnings')); ?></p>
				<p class="p2"><?php echo htmlentities($v['money']); ?></p>
			</div>
			<!-- <a class="abtn" href="<?php echo url('index/Index/feizhitui'); ?>">他的下级</a> -->
		</div>
