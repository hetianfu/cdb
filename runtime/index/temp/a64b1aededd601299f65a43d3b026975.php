<?php /*a:4:{s:60:"/www/wwwroot/hgcdb.test138.com/app/index/view/news/help.html";i:1615959590;s:64:"/www/wwwroot/hgcdb.test138.com/app/index/view/public/header.html";i:1632829661;s:62:"/www/wwwroot/hgcdb.test138.com/app/index/view/public/kefu.html";i:1616171411;s:62:"/www/wwwroot/hgcdb.test138.com/app/index/view/public/foot.html";i:1631773953;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title><?php echo htmlentities(lang('nt_notice')); ?></title>
...
<body>
    <div class="header">
        <span><?php echo htmlentities(lang('nt_notice')); ?></span>
    </div>
    <div class="back">
    ...
    <div class="helpbox">
        <ul>
            ...
            <a href="<?php echo url('index/News/xiangqing',array('id'=>$v['id'])); ?>">
                <li>
                    <img src="<?php echo htmlentities($v['pic']); ?>">
                    <p class="p1"><?php echo htmlentities($v['title']); ?></p>
                    <p class="p2"><span><?php echo htmlentities(lang('nt_reading')); ?>：<?php echo rand(1000,100000); ?></span></p>
                </li>
            </a>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            <p class="p3"><?php echo htmlentities(lang('nt_no_data')); ?></p>
        </ul>
    </div>
