<?php /*a:3:{s:62:"/opt/homebrew/var/www/cdb/app/dingadmin/view/product/edit.html";i:1645406544;s:63:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/header.html";i:1607351074;s:61:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/foot.html";i:1607351220;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>编辑产品</title>
    ...
    <form class="layui-form" action="" method="post" id="groupForm">
        ...
        <div class="layui-tab-content">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="checkbox" value="1" name="type"  <?php if($one['type'] == '1'): ?>checked<?php endif; ?> lay-skin="switch" lay-text="活期|定期">
            </div>
          </div>
