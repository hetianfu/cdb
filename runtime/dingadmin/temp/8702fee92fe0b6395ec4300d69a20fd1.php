<?php /*a:3:{s:70:"/www/wwwroot/hgcdb.test138.com/app/dingadmin/view/proconfig/index.html";i:1632722466;s:68:"/www/wwwroot/hgcdb.test138.com/app/dingadmin/view/public/header.html";i:1607351074;s:66:"/www/wwwroot/hgcdb.test138.com/app/dingadmin/view/public/foot.html";i:1607351220;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>项目配置</title>
    ...
    <div class="layui-container">
        <form class="layui-form" action="" method="post" enctype="multipart/form-data" id="groupForm">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="one_recommend" value="<?php echo !empty($config['one_profit']) ? htmlentities($config['one_profit']) : ''; ?>" autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="two_recommend" value="<?php echo !empty($config['two_profit']) ? htmlentities($config['two_profit']) : ''; ?>" autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="three_recommend" value="<?php echo !empty($config['three_profit']) ? htmlentities($config['three_profit']) : ''; ?>" autocomplete="off" class="layui-input">
                </div>
