<?php /*a:3:{s:65:"/opt/homebrew/var/www/cdb/app/dingadmin/view/proconfig/index.html";i:1645578991;s:63:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/header.html";i:1645578991;s:61:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/foot.html";i:1645578991;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>项目配置</title>
    ...
    <div class="layui-container">
        <form class="layui-form" action="" method="post" enctype="multipart/form-data" id="groupForm">
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
              <input type="text" name="top_up_ratio" value="<?php echo !empty($config['top_up_ratio']) ? htmlentities($config['top_up_ratio']) : ''; ?>" autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">%</div>
          </div>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <textarea name="sms_msg" placeholder="请输入短信模板" class="layui-textarea"><?php echo !empty($config['sms_msg']) ? htmlentities($config['sms_msg']) : ''; ?></textarea>
            </div>
          </div>


          <div class="layui-form-item">
            <label class="layui-form-label">充值文字</label>
            <div class="layui-input-block">
              <textarea name="content" placeholder="请输入充值文字" class="layui-textarea"><?php echo !empty($config['content']) ? htmlentities($config['content']) : ''; ?></textarea>
            </div>
          </div>
