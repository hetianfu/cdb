<?php /*a:3:{s:68:"/www/wwwroot/hgcdb.test138.com/app/dingadmin/view/user/addjinbi.html";i:1631967042;s:68:"/www/wwwroot/hgcdb.test138.com/app/dingadmin/view/public/header.html";i:1607351074;s:66:"/www/wwwroot/hgcdb.test138.com/app/dingadmin/view/public/foot.html";i:1607351220;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>用户充值</title>
        ...
        <div class="layui-tab-content">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo htmlentities($one['username']); ?>" readonly class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo htmlentities($one['truename']); ?>" readonly class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo htmlentities($one['money']); ?>" readonly  class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo htmlentities($one['integral']); ?>" readonly  class="layui-input">
                </div>
            </div>
...
layui.use(['form','upload','laydate'], function(){
    ...
    form.on('submit(formDemo)', function(data){
        $.ajax({
            url:"<?php echo url('User/addjinbi'); ?>",
            type:"post",
