<?php /*a:3:{s:61:"/opt/homebrew/var/www/cdb/app/dingadmin/view/agent/index.html";i:1645001235;s:63:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/header.html";i:1607351074;s:61:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/foot.html";i:1607351220;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>业务员管理</title>
...
<body style="padding: 10px 10px 80px 10px;">
    <div class="layui-container">
        <div class="ibox-title">
                <div class="row">
                    <div>
                        <a href="javascript:;" class="layui-btn layui-btn-small" onclick="admin_add('添加业务员','<?php echo url('agent/add'); ?>',540,440)">添加业务员</a>
                    </div>
                </div>
            </div>
        <table class="layui-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th><?php echo htmlentities($vo['code']); ?></th>
                    <th><?php echo htmlentities($vo['server_code']); ?></th>
                    <td>
                        <a href="javascript:;" class="layui-btn layui-btn-sm" onclick="admin_edit('编辑业务员','<?php echo url('agent/edit',['id'=>$vo['id']]); ?>',540,440)">编辑</a>
        ...
        <div style="text-align: right;"><?php echo htmlentities($page); ?></div>
    </div>
