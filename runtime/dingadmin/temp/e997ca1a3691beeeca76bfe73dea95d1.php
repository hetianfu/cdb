<?php /*a:3:{s:65:"/opt/homebrew/var/www/cdb/app/dingadmin/view/top_active/edit.html";i:1645150913;s:63:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/header.html";i:1607351074;s:61:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/foot.html";i:1607351220;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>修改活动</title>
...
<script>
  ...
  layui.use(['form','upload','laydate'], function(){
    ...
    //动态回显input值
    var ycList = "<?php echo htmlentities($article['content']); ?>";
    var approvalNameArr = ycList.replace(/&quot;/g,'"');
    approvalNameArr =$.parseJSON(approvalNameArr);
   // var approvalNameArr = approvalNameStr.split(',');
    ...
    $.each(approvalNameArr,function (i,json) {
      ...
      if(kk>0){
        var str =  '<div class="layui-form-item">'+
          '<label class="layui-form-label"></label>'+
          '<div class="layui-input-inline">'+
          '<input type="text" name="amount[]" value="'+i+'" placeholder="请输入金额" class="layui-input input-double-width">'+
          '</div>'+
          '<div class="layui-input-inline">'+
          '<input type="text" name="jl_amount[]"  value="'+json+'"  placeholder="请输入赠送金额" class="layui-input input-double-width">'+
          '</div>'+
          '<div class="layui-input-inline" >'+
          '<button type="button" class="layui-btn layui-btn-danger layui-btn-sm removeclass"><i class="layui-icon">&#xe67e;</i></button>'+
          '</div>'+
    ...
    form.on('submit(formDemo)', function(data){
      $.ajax({
        url:"<?php echo url('TopActive/edit'); ?>",
        type:"post",
