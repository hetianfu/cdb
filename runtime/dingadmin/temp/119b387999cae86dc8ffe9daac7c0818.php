<?php /*a:3:{s:60:"/opt/homebrew/var/www/cdb/app/dingadmin/view/index/main.html";i:1645578989;s:63:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/header.html";i:1645578991;s:61:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/foot.html";i:1645578991;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<title>网站配置</title>
...
<div class="layui-collapse" lay-accordion="" lay-filter="collapse">
    ...
    <div class="layui-col-md4 d-flex j-center a-center layui-bg-blue flex-column">
      <h2>实际入金总额  <?php echo htmlentities($statistical['into_amount']); ?></h2>
    </div>


    <div class="layui-col-md4 d-flex j-center a-center layui-bg-yellow flex-column">
      <h2>实际出金总额  <?php echo htmlentities($statistical['out_amount']); ?></h2>
    </div>


    <div class="layui-col-md4 d-flex j-center a-center layui-bg-red flex-column">
      <h2>实际总余额  <?php echo htmlentities($statistical['actual_amount']); ?></h2>
    </div>

    <div class="layui-col-md4 d-flex j-center a-center layui-bg-yellow flex-column">
      <h2>昨日新增首充人数  <?php echo htmlentities($statistical['recharge_count_oo']); ?></h2>
    </div>

    <div class="layui-col-md4 d-flex j-center a-center layui-bg-blue flex-column">
      <h2>昨日总充值人数  <?php echo htmlentities($statistical['recharge_count']); ?></h2>
    </div>
