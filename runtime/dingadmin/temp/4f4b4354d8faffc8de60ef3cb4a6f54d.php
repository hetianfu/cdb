<?php /*a:3:{s:62:"/opt/homebrew/var/www/cdb/app/dingadmin/view/active/index.html";i:1645085045;s:63:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/header.html";i:1607351074;s:61:"/opt/homebrew/var/www/cdb/app/dingadmin/view/public/foot.html";i:1607351220;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>活动列表</title>
...
<body style="padding: 10px 10px;">
    ...
    <div class="layui-container">
        <div>
            <a href="javascript:;" class="layui-btn layui-btn-small" onclick="admin_add('添加','<?php echo url('active/add'); ?>',850,600)">添加</a>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <td>
                        <a href="javascript:;" class="layui-btn layui-btn-sm" onclick="admin_edit('编辑','<?php echo url('active/edit',['id'=>$vo['id']]); ?>',850,600)">编辑</a>
...
layui.use(['layer','form'], function(){
    ...
    form.on('select(lanmu)', function(data){
        var cid = data.value;
        location.href = "<?php echo url('active/index'); ?>?cid="+cid;
    });   
    //置顶切换操作
        ...
        $.ajax({
            ...
            success:function(msg){
                layer.msg(msg.msg,{time:1000},function(){
                    location.href = "<?php echo url('active/index'); ?>";
                });
            }
        });
    }); 
